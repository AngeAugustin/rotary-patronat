export function buildMembershipApplicationAcceptedEmail(input: {
  firstName: string;
  lastName: string;
  includeLogo?: boolean;
}) {
  const clubName = 'Rotary Club Cotonou Le Nautile Patronat';
  const subject = 'Votre demande d\'adhésion a été acceptée';
  const includeLogo = input.includeLogo ?? false;

  const greeting = `Bonjour ${input.firstName} ${input.lastName},`;

  const body = [
    'Nous avons le plaisir de vous informer que votre demande d\'adhésion au Rotary Club Cotonou Le Nautile Patronat — Club Satellite Passeport a été acceptée.',
    'Vous faites désormais partie de notre communauté. Un membre de l\'équipe vous recontactera prochainement pour les prochaines étapes de votre intégration.',
    'Bienvenue parmi nous, et merci pour votre engagement au service de l\'action rotarienne.',
  ].join('\n\n');
              ...
              <td style="background:#17458F;padding:24px 28px;">
                <table role="presentation" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td valign="middle">
                      <p style="margin:0;font-size:13px;letter-spacing:0.04em;text-transform:uppercase;color:#D6E2F5;">Adhésion acceptée</p>
            ...
            <tr>
              <td style="padding:28px;">
                ...
                <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#334155;">
                  Nous avons le plaisir de vous informer que votre demande d'adhésion au <strong>Rotary Club Cotonou Le Nautile Patronat</strong> — Club Satellite Passeport a été <strong>acceptée</strong>.
                </p>
                <p style="margin:0 0 16px;font-size:15px;line-height:1.7;color:#334155;">
                  Vous faites désormais partie de notre communauté. Un membre de l'équipe vous recontactera prochainement pour les prochaines étapes de votre intégration.
                </p>
            ...
            <tr>
              <td style="padding:0 28px 28px;">
                <p style="margin:0;font-size:13px;line-height:1.6;color:#94A3B8;">
                  Cet e-mail confirme l'acceptation de votre candidature. Conservez-le pour vos archives.
                </p>
              </td>
            </tr>
          </table>
